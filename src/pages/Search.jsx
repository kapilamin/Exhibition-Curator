...
//         const match = mediumLower.includes(filters.medium.toLowerCase());
//         return match;
//       });
//     }

//     // Image and details filters
//     filtered = filtered.filter(artwork => 
//       (!filters.hasImage || artwork.image) &&
//       (!filters.hasDetails || (artwork.medium && artwork.dimensions))
//     );
...
const Search = () => {
  ...
  useEffect(() => {
    ...
    if (hasSearched) {
      ...
      // Apply filters to featured artworks
